...
<body>
    <nav class="navbar navbar-dark bg-dark">
            <span class="navbar-brand mb-0 h1">Ayo Belajar Coding</span>
        </div>
    </nav>
<div class="container">
    <br>
    <h4><center>DAFTAR PESERTA PELATIHAN CODING</center></h4>
    <h5><center>Halo, Admin. Ini merupakan sebuah halaman website untuk menginput, mengedit, serta menampilkan
    daftar peserta pelatihan coding di "Ayo Belajar Coding".</center></h5>
<?php
